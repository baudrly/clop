...
def protein_to_dna(protein_sequence):
    ...
    for amino_acid in protein_sequence:
        if amino_acid in genetic_code:
            ...
            raise ValueError(
                f"Invalid amino acid '{amino_acid}' found in the input sequence."
            )
...
if __name__ == "__main__":
    preprocess_inputs(
        r"data//uniprotkb_taxonomy_id_9606_AND_model_or_2023_11_30.tsv",
        r"data//",
    )
    # img = fcgr('ACG', k=3)
    # print(img,)
